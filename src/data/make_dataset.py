...
def get_labels(application_df_transformed: pd.DataFrame, credit_df: pd.DataFrame) -> pd.Series:
    """
    ...
    credit_df_transformed = credit_df_transformed.merge(application_df_transformed[['ID', 'CLIENT_ID']],
                                                        on='ID',
                                                        how='inner')
...
def get_initial_df(application_df_transformed: pd.DataFrame, data_labels: pd.Series) -> pd.DataFrame:
    """
    ...
    """
    initial_preprocessed_df = application_df_transformed.merge(data_labels, how='inner', on='CLIENT_ID')
