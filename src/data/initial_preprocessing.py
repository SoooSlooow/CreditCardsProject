...
def initial_preprocessing(input_filepath_app_data, input_filepath_credit_data, output_filepath):
...
# python -m src.data.initial_preprocessing data/raw/application_record.csv data/raw/credit_record.csv data/interim/initial_preprocessed_data.csv
